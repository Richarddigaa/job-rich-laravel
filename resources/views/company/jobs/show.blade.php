...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h5 class="mb-0 font-weight-bold text-primary">Detail Lowongan Pekerjaan</h5>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap mb-4">
                    ...
                    <div class="d-flex flex-column flex-sm-row align-items-center mb-3">
                        <a href="{{ route('company.jobs.edit', [$personalCompany->slug_company, $jobVacancy->slug_job_position]) }}" class="btn btn-outline-primary mb-2 mb-sm-0 mr-sm-2">
                            <i class="far fa-fw fa-edit"></i> Edit
                        </a>
                        <form id="delete-form-{{ $jobVacancy->id }}" action="{{ route('company.jobs.destroy', [$personalCompany->slug_company, $jobVacancy->slug_job_position]) }}" method="POST">
                            @csrf
                            @method('DELETE')
