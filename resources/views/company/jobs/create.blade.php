...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h5 class="mb-0 font-weight-bold text-primary">Tambah Lowongan Pekerjaan</h5>
    </div>

    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header py-3 text-center">
                <h6 class="m-0 font-weight-bold text-dark">TAMBAH LOWONGAN PEKERJAAN</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="{{route('company.jobs.store', $personalCompany->slug_company)}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <!-- Kolom Kiri -->
                        <div class="col-md-6">
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        ...
                        <a href="{{route('company.jobs.index', $personalCompany->slug_company)}}" class="btn btn-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
