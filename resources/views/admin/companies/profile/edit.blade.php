...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h5 class="mb-0 font-weight-bold text-primary">Ubah Profil Perusahaan</span></h5>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-body px-4 py-5">
                    ...
                    <form method="POST" action="{{ route('admin.companies.profile.update', $personalCompany->slug_company) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <!-- Kolom Kiri: Logo -->
