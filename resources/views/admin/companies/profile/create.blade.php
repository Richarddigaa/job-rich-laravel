...
@section('title', 'Tambah Profil Perusahaan | JobRich')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h5 class="mb-0 font-weight-bold text-primary">Tambah Profil Perusahaan</h5>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-body px-4 py-5">
                    <h4 class="mb-4 text-center font-weight-bold">Profil Perusahaan</h4>
                    <form method="POST" action="{{ route('admin.companies.profile.store', $user->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <!-- Kolom Kiri: Logo -->
                        ...
                        <button type="submit" class="btn btn-primary d-block mx-auto mt-4 px-4">Tambah Profil Perusahaan</button>
                    </form>
                </div>
            </div>
        </div>
