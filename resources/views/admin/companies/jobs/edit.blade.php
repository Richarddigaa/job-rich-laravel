...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h5 class="mb-0 font-weight-bold text-primary">Ubah Lowongan Pekerjaan {{ $personalCompany->name_company }}</h5>
    </div>
    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{route('admin.companies.jobs.update', [$personalCompany->slug_company, $jobVacancy->slug_job_position])}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <!-- Kolom Kiri -->
